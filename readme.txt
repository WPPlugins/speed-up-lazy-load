...
Simply add a string 'no-lazy-area' in the area (eg. in a page write '<!-- no-lazy-area -->').

= How can i deactivate Lazy Load on some images? = 

Simply add a string 'no-lazy' in you IMG tag (eg. in the class, alt, title or file name).
