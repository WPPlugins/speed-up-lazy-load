...
class SpeedUp_LazyLoad {
    ...
    public function add_lazy_to_image_preg_replace_callback($matches){
        ...
        return '<img'.$prepend.'src="data:image/gif;base64,R0lGODlhAQABAIAAAAAAAP///yH5BAEAAAAALAAAAAABAAEAAAIBRAA7" '.self::DATASRC.'="'.$src.'"'.$append.'><noscript><img'.$prepend.'src="'.$src.'"'.$append.'></noscript>';
    }
    ...
    public function add_lazy_to_iframe_preg_replace_callback($matches){
        ...
        return '<iframe'.$prepend.'src="about:blank" '.self::DATASRC.'="'.$src.'"'.$append.'></iframe>';
    }
